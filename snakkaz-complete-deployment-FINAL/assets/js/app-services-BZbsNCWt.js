...
var _a;
import { s as supabase } from "./app-utils-CtXfdYCF.js";
import { n as nanoid } from "./vendor-misc-CRWzYzLL.js";
import { s as secureKeyStorage } from "./vendor-security-LdHy7Pt9.js";
const MODE = typeof window !== "undefined" && ((_a = window.import_meta_env) == null ? void 0 : _a.MODE) || "production";
...
const verifySupabaseConfig = () => {
  try {
    console.log("🔧 Supabase config verification: Starting...");
    const url = ENV.SUPABASE_URL;
    const key = ENV.SUPABASE_ANON_KEY;
    if (!url || !key) ;
    console.log("✅ Supabase config verification: Valid");
    return true;
  } catch (error) {
    console.warn("⚠️ Supabase config verification failed:", error);
    return false;
  }
};
console.log("🔧 SupabasePatch loaded successfully");
  ...
  async getChatRooms() {
    try {
      ...
      return (data == null ? void 0 : data.map((room) => {
        ...
        return {
          ...room,
          participant_count: ((_b = (_a2 = room.participant_count) == null ? void 0 : _a2[0]) == null ? void 0 : _b.count) || 0
        };
      })) || [];
    } catch (error) {
...
//# sourceMappingURL=app-services-BZbsNCWt.js.map
