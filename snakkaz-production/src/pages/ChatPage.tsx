                ...
                <div className="flex-1 overflow-y-auto">
                    {rooms.map((room) => (
                        <div
                            ...
                            className={`p-4 border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition-colors ${activeRoom?.id === room.id ? 'bg-blue-50 border-r-2 border-r-blue-600' : ''
                                }`}
                        >
                    ...
                    <>
                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-4">
                            {messages.map((message) => (
                                ...
                                >
                                    <div
                                        className={`max-w-xs lg:max-w-md ${message.user_id === user.id
                                    ...
                                    >
                                        ...
                                        <div
                                            className={`text-xs mt-1 opacity-70 ${message.user_id === user.id ? 'text-right' : 'text-left'
                                                }`}
                                        >
