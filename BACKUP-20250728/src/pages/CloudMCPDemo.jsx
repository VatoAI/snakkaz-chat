            ...
            <div className="chat-demo">
              <div className="message-bubble ai">
                ...
                <div className="message-content">
                  Welcome to CloudMCP! I&apos;m your quantum AI assistant. How
                  can I help you today?
                </div>
              </div>
              <div className="message-bubble user">
                <div className="message-content">Show me the system status</div>
                <div className="message-avatar">👤</div>
              </div>
              <div className="message-bubble ai">
                <div className="message-avatar">🤖</div>
                <div className="message-content">
                  All systems operational. Quantum processors running at 98.7%
                  efficiency.
