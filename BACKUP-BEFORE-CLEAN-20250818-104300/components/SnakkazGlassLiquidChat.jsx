...
const SnakkazGlassLiquidChat = () => {
  ...
  const [messages, setMessages] = useState([
    ...
    },
    {
      ...
      sender: "You",
      content:
        "Wow, this looks amazing! Love the CloudMCP-inspired interface 😍",
      time: "12:31",
      type: "sent",
    },
    {
      ...
      avatar: "TC",
      content:
        "The glass morphism effects are incredible! How did you achieve this?",
      time: "12:32",
      type: "received",
    },
    {
      ...
      sender: "You",
      content:
        "It's all about layering backdrop-filters with gradients and subtle animations ✨",
      time: "12:33",
      type: "sent",
    },
  ]);
    ...
    if (isConnected) {
        ...
        if (response.ok) {
          ...
          setTimeout(() => {
            const responseMessage = {
              ...
              avatar: "MC",
              content:
                mcpResponse.response || "Message received and processed! 🚀",
              time: new Date().toLocaleTimeString("no-NO", {
                hour: "2-digit",
                minute: "2-digit",
              }),
      ...
      setTimeout(() => {
        ...
        const response = {
          ...
          avatar: "GL",
          content:
            "That message looks beautiful with our glass liquid design! 🌟",
          time: new Date().toLocaleTimeString("no-NO", {
            hour: "2-digit",
            minute: "2-digit",
          }),
      ...
      <div className="cloudmcp-chat-container">
        ...
        <aside className="cloudmcp-sidebar">
          <div className="cloudmcp-header">
            <h1
              className="glow-text"
              style={{ fontSize: "24px", margin: "0 0 16px 0" }}
            >
              SnakkaZ
            </h1>
          ...
          <div className="cloudmcp-chat-list">
            {[
              {
                name: "Team CloudMCP",
                message: "Check out the new design!",
                time: "12:30",
                unread: 3,
                online: true,
              },
              {
                name: "Design System",
                message: "Glass morphism is trending",
                time: "11:45",
                unread: 0,
                online: true,
              },
              {
                name: "Apple Inspired",
                message: "Liquid animations added",
                time: "Yesterday",
                unread: 0,
                online: false,
              },
              {
                name: "Premium UI/UX",
                message: "Backdrop filters are amazing",
                time: "Monday",
                unread: 0,
                online: false,
              },
              ...
              <div
                key={index}
                className={`cloudmcp-chat-item ${index === 0 ? "active" : ""}`}
              >
