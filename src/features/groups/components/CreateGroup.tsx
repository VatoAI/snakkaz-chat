...
export const CreateGroup: React.FC<CreateGroupProps> = ({ onSuccess, onCancel }) => {
  ...
  const { handleCreateGroup } = useGroups({ currentUserId: '' }); // This will be properly initialized in actual use
