    ...
    <div className="container mx-auto py-8 px-4 max-w-4xl">
        ...
        <div className="md:col-span-1">
          <Card className="bg-cyberdark-900 border-cyberdark-700">
            ...
            <CardContent className="flex flex-col items-center">
              <div className="relative group mb-4"></div>
      ...
      <div className="md:col-span-2">
        <Tabs defaultValue="profile" className="w-full">
          <TabsList className="w-full grid grid-cols-3 bg-cyberdark-800"></TabsList>
        ...
        <TabsContent value="security" className="mt-4">
          <Card className="bg-cyberdark-900 border-cyberdark-700">
            ...
            <CardContent className="space-y-4">
              ...
              {isPremium && (
                    <Button variant="outline" className="w-full border-cyberdark-600 text-gray-300"></Button>
