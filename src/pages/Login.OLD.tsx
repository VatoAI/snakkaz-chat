...
import { Shield, Lock, Users, ArrowLeft, Mail, Eye, EyeOff, Github, Chrome, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="norwegian-aurora-login">
      ...
      <div className="login-container">
        {/* Back Button */}
        <Link to="/" className="back-button glass-morphism">
          <ArrowLeft size={16} />
          <span>Tilbake</span>
        </Link>
        ...
        <div className="login-header">
          ...
          <p className="welcome-subtitle">Logg inn til din SnakkaZ konto</p>
        </div>
        ...
        <div className="login-form-container glass-morphism-ultra">
          <form onSubmit={handleSubmit} className="login-form">
            ...
            <Link 
              to="/chat" 
              className="demo-chat-btn glass-morphism-ultra"
              style={{
                display: 'flex',
                alignItems: 'center',
          ...
          <div className="login-actions">
            ...
            <div className="social-login">
              <button className="social-btn github glass-morphism" disabled>
              ...
              <button className="social-btn google glass-morphism" disabled>
                <div className="social-icon-wrapper">
                  <Chrome size={18} />
                </div>
                <div className="social-content">
